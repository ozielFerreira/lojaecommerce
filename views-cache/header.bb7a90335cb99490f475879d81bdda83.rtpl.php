  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="#" class="logo">
        ...
        <span class="logo-mini" style="font-size: 80%;"><b>E</b>COM</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Loja</b>Ecommerce</span>
      </a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            <a href="#"><i class="fa fa-link"></i> <span>Menu Categorias</span>
