...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            De
            <address>
                <strong>LojaEcommerce</strong><br>
                Rua Visconde de Sepetiba, 187<br>
                Centro - Niterói - RJ<br>
                Telefone: (21) 2717-0000<br>
                Email: suporte@lojaecommerce.com
            </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
            ...
            <address>
                ...
                Email: <?php echo htmlspecialchars( $order["desemail"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
            </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
