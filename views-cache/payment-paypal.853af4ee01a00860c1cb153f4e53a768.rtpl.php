<?php if(!class_exists('Rain\Tpl')){exit;}?><form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
    <input type="hidden" name="cmd" value="_cart">
    <input type="hidden" name="upload" value="1">
    <imput type="hidden" name="charset" value="utf-8">
    <input type="hidden" name="business" value="ozielcf@gmail.com">
    ...
    <?php } ?>
    <input type="hidden" name="shipping_1" value="<?php echo htmlspecialchars( $cart["vlfreight"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
