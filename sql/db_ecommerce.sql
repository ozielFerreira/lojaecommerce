...
--
-- Host: localhost:3306
-- Generation Time: 18-Jun-2018 às 16:26
...
-- Procedures
--
CREATE DEFINER=`id6214556_lojaecommerce`@`%` PROCEDURE `sp_addresses_save` (`pidaddress` INT(11), `pidperson` INT(11), `pdesaddress` VARCHAR(128), `pdesnumber` VARCHAR(16), `pdescomplement` VARCHAR(32), `pdescity` VARCHAR(32), `pdesstate` VARCHAR(32), `pdescountry` VARCHAR(32), `pdeszipcode` CHAR(8), `pdesdistrict` VARCHAR(32))  BEGIN
...
CREATE DEFINER=`id6214556_lojaecommerce`@`%` PROCEDURE `sp_carts_save` (`pidcart` INT, `pdessessionid` VARCHAR(64), `piduser` INT, `pdeszipcode` CHAR(8), `pvlfreight` DECIMAL(10,2), `pnrdays` INT)  BEGIN
...
CREATE DEFINER=`id6214556_lojaecommerce`@`%` PROCEDURE `sp_categories_save` (`pidcategory` INT, `pdescategory` VARCHAR(64))  BEGIN
...
CREATE DEFINER=`id6214556_lojaecommerce`@`%` PROCEDURE `sp_orders_save` (`pidorder` INT, `pidcart` INT(11), `piduser` INT(11), `pidstatus` INT(11), `pidaddress` INT(11), `pvltotal` DECIMAL(10,2))  BEGIN
...
CREATE DEFINER=`id6214556_lojaecommerce`@`%` PROCEDURE `sp_products_save` (`pidproduct` INT(11), `pdesproduct` VARCHAR(64), `pvlprice` DECIMAL(10,2), `pvlwidth` DECIMAL(10,2), `pvlheight` DECIMAL(10,2), `pvllength` DECIMAL(10,2), `pvlweight` DECIMAL(10,2), `pdesurl` VARCHAR(128))  BEGIN
...
CREATE DEFINER=`id6214556_lojaecommerce`@`%` PROCEDURE `sp_userspasswordsrecoveries_create` (`piduser` INT, `pdesip` VARCHAR(45))  BEGIN
...
CREATE DEFINER=`id6214556_lojaecommerce`@`%` PROCEDURE `sp_usersupdate_save` (`piduser` INT, `pdesperson` VARCHAR(64), `pdeslogin` VARCHAR(64), `pdespassword` VARCHAR(256), `pdesemail` VARCHAR(128), `pnrphone` BIGINT, `pinadmin` TINYINT)  BEGIN
...
CREATE DEFINER=`id6214556_lojaecommerce`@`%` PROCEDURE `sp_users_delete` (`piduser` INT)  BEGIN
...
CREATE DEFINER=`id6214556_lojaecommerce`@`%` PROCEDURE `sp_users_save` (`pdesperson` VARCHAR(64), `pdeslogin` VARCHAR(64), `pdespassword` VARCHAR(256), `pdesemail` VARCHAR(128), `pnrphone` BIGINT, `pinadmin` TINYINT)  BEGIN
...
(11, 1, 'Rua da Conceição', '90', 'de 80 a 164 - lado par', 'Niterói', 'RJ', 'Brasil', '24020084', 'Centro', '2018-06-16 17:23:58'),
(12, 1, 'Rua da Conceição', '90', 'de 80 a 164 - lado par', 'Niterói', 'RJ', 'Brasil', '24020084', 'Centro', '2018-06-16 17:24:31'),
(13, 11, 'Travessa Lira', '187', '', 'Niterói', 'RJ', 'Brasil', '24020205', 'Centro', '2018-06-16 17:31:15'),
(14, 1, 'Rua da Conceição', '80', 'de 80 a 164 - lado par', 'Niterói', 'RJ', 'Brasil', '24020084', 'Centro', '2018-06-18 04:04:01'),
(15, 1, 'Rua da Conceição', '80', 'de 80 a 164 - lado par', 'Niterói', 'RJ', 'Brasil', '24020084', 'Centro', '2018-06-18 04:06:47');
...
(7, '27nr429k3qio4hn98jb1hbdloa', NULL, '24020084', 51.32, 1, '2018-06-16 17:13:43'),
(8, 'aun7nglr5i4s2gor201omfudpa', NULL, '24020205', 36.32, 1, '2018-06-16 17:30:12'),
(9, '8cdclmjlo1iafsnotmeh3gs4k2', NULL, '24020084', 0.00, 0, '2018-06-17 12:51:56'),
(10, '835ub4o1fkttt3jn1spcp1a3bp', NULL, '24020084', 51.32, 1, '2018-06-18 04:00:18'),
(11, '1gn2osjnhi8grde0omvq4pb49m', NULL, NULL, NULL, NULL, '2018-06-18 04:07:34'),
(12, 'iololecdeum7q8qn8edp0lqdgg', NULL, NULL, NULL, NULL, '2018-06-18 16:12:06');
...
(17, 7, 6, '2018-06-16 17:30:02', '2018-06-16 17:23:31'),
(18, 7, 6, '2018-06-16 17:30:02', '2018-06-16 17:23:34'),
(19, 8, 6, NULL, '2018-06-16 17:30:50'),
(20, 9, 7, '2018-06-17 12:58:11', '2018-06-17 12:53:58'),
(21, 9, 7, '2018-06-17 12:58:11', '2018-06-17 12:56:21'),
(22, 9, 7, '2018-06-17 12:58:11', '2018-06-17 12:56:22'),
(23, 9, 7, '2018-06-17 12:58:11', '2018-06-17 12:56:24'),
(24, 9, 7, '2018-06-17 12:58:11', '2018-06-17 12:56:25'),
(25, 9, 7, '2018-06-17 12:58:11', '2018-06-17 12:57:45'),
(26, 9, 7, '2018-06-17 12:58:11', '2018-06-17 12:57:46'),
(27, 10, 6, NULL, '2018-06-18 04:00:56');
...
(4, 'Motorola', '2018-06-16 17:25:50'),
(5, 'Samsung', '2018-06-16 17:26:00');
...
(4, 7, 1, 1, 12, 2051.12, '2018-06-16 17:24:33'),
(5, 8, 11, 1, 13, 1036.22, '2018-06-16 17:31:16'),
(6, 10, 1, 1, 14, 2051.22, '2018-06-18 04:04:02'),
(7, 10, 1, 1, 15, 2051.22, '2018-06-18 04:06:48');
...
(1, 'Administrador', 'admin@hcode.com.br', 11912345678, '2017-09-29 14:49:51'),
(11, 'oziel da Costa Ferreira', 'teste@gmail.com', 21999244944, '2018-06-16 17:30:31');
...
(6, 'Ipad 32GB Tela 9,7', 1999.90, 16.00, 10.00, 18.00, 0.35, 'ipad-32-tela-9-7', '2018-06-16 17:22:38'),
(7, 'iPhone 8 Plus Dourado 64GB', 5990.99, 15.00, 8.00, 16.00, 0.10, 'iphone-8-plus-dourado-64gb', '2018-06-16 17:28:25');
...
(1, 1, 'admin', '$2y$12$K//3jS6gFYzwDViewONa.uBWmbrxES.3Kl/nTqWUlcazV6Xiej1SK', 1, '2017-09-29 14:49:52'),
(11, 11, 'teste@gmail.com', '$2y$12$OKNBQHErELOLZAyjN1cnxuiw5DsTZ4U38jzJnSlGx5XTvuYTowHQi', 0, '2018-06-16 17:30:31');
...
--
ALTER TABLE `tb_addresses`
  MODIFY `idaddress` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
